					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><img src="assets/images.png" alt="Logo Surat Menyurat" width="50"></div>
								<h5 class="content-group">Sistem Informasi Manajemen Arsip surat<small class="display-block">Silahkan Masuk</small></h5>
								<?php
